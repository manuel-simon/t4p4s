    ...
    apply {
        ...
        if (a_0)  {
            if (hdr.udp.dstPort == 7004) {
		        ...
		        ebpf_prog_0.load_prog_from_packet(ret_0, {hdr.program.len, hdr.program.binary1, hdr.program.binary2, hdr.program.binary3, hdr.program.binary4});
                
	        } else {
                
                ebpf_prog_0.exec_prog_packet(ret_0);
                
            }
        } else {
            ebpf_prog_0.load_prog_from_memory(ret_0, "/root/dyn-ebpf/bins/dummy.o");
        }
